...
export default function ProtectedLayout({
  ...
  return (
    <SiteChrome>
      <main
      className="relative min-h-dvh flex flex-col items-center bg-brand-green bg-top bg-no-repeat bg-[length:100%_auto] pt-24 pb-12 px-4 sm:pt-28 sm:pb-16 md:px-8"
