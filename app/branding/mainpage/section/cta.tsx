    ...
    <section className="relative mx-auto flex w-full max-w-[1440px] flex-col items-center px-4 py-16 text-center md:px-8 md:py-24">
      ...
      <Reveal delay={0.1}>
        <p className="z-10 mt-6 max-w-[65ch] text-[clamp(15px,1.6vw,18px)] leading-[1.6] text-white/85">
          ...
          diverse professionals, ranging from leading multinational corporations
          to innovative startups. These partnerships significantly enrich our
          event content, offering participants fresh insights and connecting
          them with industry leaders and expert practitioners.
        </p>
      </Reveal>
      ...
      <Reveal delay={0.28}>
        <p className="z-10 mt-4 text-xs text-white/50">
          Partnership &amp; competition contacts →
        </p>
      </Reveal>
    </section>
  );
